...
<html>
    ...
    <body>
        ...
        <%
            ...
            String sql2="SELECT user.name, user.staffID, user.userID, user.qualification, tf_member.position, tf_member.GStatus, tf_member.startDate, tf_member.endDate FROM tf_member INNER JOIN user ON tf_member.userID=user.userID WHERE tf_member.tfID='"+taskID+"' AND tf_member.status='active'";
            String sql3="SELECT user.name, user.qualification, user.userID, user.staffID, tf_member.position, tf_member.GStatus, tf_member.startDate, tf_member.endDate FROM tf_member JOIN user ON tf_member.userID=user.userID WHERE tf_member.tfID='"+taskID+"' AND tf_member.status='not active'";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="#" method="post" > <?---where to,action & method---?>
                                                <input type="hidden" name="taskID" value="<%=taskID%>">
                                                <input type="hidden" name="staffID" value="<%=StaffID%>">
                                                <input type="submit" value="Create Appointment Letter">
                                            </form>
                                        </td>
                                    </tr>
                                 <%
